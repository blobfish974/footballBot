    ...
    return f.incoming(req, res, async data => {
        try {
            ...
            if(data.type=='text'){
                ...
                else if (data.content === 'je t\'aime') {
                ...
                if (req_message === 'GOALKEEPER' || req_message === 'DEFENDER' || req_message === 'MIDFIELDER' ||
                    ...
                    switch(intent){
                        ...
                        case "squad":
                            ...
                            break;
                        case "information":
                            sandbox_teams.team_information(team).then( async res => {// return [image_url,return_string,website_url, email, phone_number]]
                                    var image_url=res[0];
                                    var text=res[1];
                                    ...
                                    await f.sendButtonClub(data.sender, website_url,email,phone_number);
                            });
                            break;
                        default:
